...
### Contains all parameters for training: Loss Function, Optimiser, NumberOfEpochs, InitialLearningRate, SaveAfterEpoch 
    ...
    def Train(self, model, TrainingDataFile, bs = 100000, L1perUnit=None, UseGPU=True, Name="", Folder=os.getcwd(), WeightClipping=False, L1Max=1, ValidationDataFile = None, scaleloss = 1., lossplot = True, testparameters=None,
